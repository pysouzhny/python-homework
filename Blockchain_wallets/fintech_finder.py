...
st.sidebar.markdown(cw.get_balance(w3,account.address))
st.sidebar.markdown("---------")
...
if st.sidebar.button("Send Transaction"):
    ...
    transaction_hash = cw.send_transaction(w3, account, candidate_address, wage)
